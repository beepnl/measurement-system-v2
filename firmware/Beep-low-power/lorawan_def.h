...
typedef struct
{
	...
	eBACKENDS			back_end				= The_Things_Network;				//	Variable to identify which back-end is used and to provide automatic OTAA and data messages channel, datarate and timeslot configuration.
	...
	sLoRa_OTAA OTAA =
	{
		.DevEUI   = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // MSB 
		.AppEUI   = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // MSB
		.AppKey   = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, // MSB
		.DevNonce = {0},
		.AppNonce = {0},
		.NetID    = {0},
		.OTAAdone = false,
